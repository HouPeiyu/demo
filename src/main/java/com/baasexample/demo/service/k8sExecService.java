...
public class k8sExecService {
    ...
    public static String KubectlExec(String PodName, String NameSpace, String ShellCommand) throws IOException, ApiException, ParseException, InterruptedException {
